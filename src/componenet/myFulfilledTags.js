...
class MyFulfilledTags extends Component {
    ...
    componentDidMount() {
        this.fetchMyFulfilledTags();
    }

    async fetchMyFulfilledTags() {
...
export default withStyles(styles)(connect(mapStateToProps, undefined)(MyFulfilledTags));
